...
- [x] CHUNK-001 — Failure detection: pipefail + is_error + real exit codes (+ test hooks) (RESOLVED 2026-08-25, commit <short-hash>)
- [ ] CHUNK-002 — Fail-safe PRD completion predicate (shared jq, `passes != true`)
...
### CHUNK-001 — Failure detection: pipefail + is_error + real exit codes (+ test hooks) (RESOLVED 2026-08-25 | commit <short-hash>)
